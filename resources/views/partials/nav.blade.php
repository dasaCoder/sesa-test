...
@endauth
    ...
    {{--<div class="header" id="home">
        <div class="container">
            <ul>
                        <li class=""><i class="fa fa-computer" aria-hidden="true"></i>Software Engineering Students' Association</li>
                        @guest
                        <li class="login-li"> <a href="#" --}}{{-- data-toggle="modal" data-target="#loginModal"--}}{{--><i class="fa fa-unlock-alt" aria-hidden="true"></i> Sign In </a></li>
                        <li> <a href="{{url('register')}}" --}}{{--data-toggle="modal" data-target="#signupModal"--}}{{--><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Sign Up </a></li>
                        @else
                        <li > <a href="#" data-toggle="modal" data-target="#loginModal"><i class="fa fa-user" aria-hidden="true"></i>{{ Auth::user()->name }} </a>
                            <a href="{{ route('logout') }}" onclick="
                            event.preventDefault();
                             document.getElementById('logout-form').submit();">
                                <span  id="logout_btn" class="fa fa-sign-out"></span></a></li>
                    @endguest
